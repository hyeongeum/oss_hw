...
| **Item**               | **설명**                                                       |
|------------------------|-----------------------------------------------------------------------|
| 요약                | Player가 게임을 실행한 뒤 Project A+의 학기 진행을 시작하기 위한 기능 |
| Scope                  | Project A+                                                            |
| Level                  | User level                                                            |
| 작성자                 | 류재민                                                                |
...
| **Item**               | **설명**                                                                 |
|------------------------|---------------------------------------------------------------------------------|
| 요약                | Player가 캐릭터를 이동, 점프, 회피시켜 스테이지를 진행하기 위한 기능            |
| Scope                  | Project A+                                                                      |
| Level                  | User level                                                                      |
| 작성자                 | 류재민                                                                          |
| Last Update            | 2026-05-07                                                                      |
...
| **Item**               | **설명**                                                          |
|------------------------|--------------------------------------------------------------------------|
| 요약                | Player가 일반 몬스터, 과제 몬스터, 시험 보스와 전투하기 위한 기능        |
| Scope                  | Project A+                                                               |
| Level                  | User level                                                               |
| 작성자                 | 류재민                                                                   |
| Last Update            | 2026-05-07                                                               |
...
| **Item**               | **설명**                                                                    |
|------------------------|------------------------------------------------------------------------------------|
| 요약                | Player가 적 처치 또는 스테이지 클리어 후 경험치, 아이템, 점수를 획득하기 위한 기능 |
| Scope                  | Project A+                                                                         |
| Level                  | User level                                                                         |
| 작성자                 | 류재민                                                                             |
| Last Update            | 2026-05-07                                                                         |
...
| **Item**               | **설명**                                                           |
|------------------------|---------------------------------------------------------------------------|
| 요약                | Player가 획득한 성장 포인트를 공부량, 멘탈 등 능력치에 분배하기 위한 기능 |
| Scope                  | Project A+                                                                |
| Level                  | User level                                                                |
| 작성자                 | 류재민                                                                    |
| Last Update            | 2026-05-07                                                                |
...
| **Item**               | **설명**                                                           |
|------------------------|---------------------------------------------------------------------------|
| 요약                | Player가 게임을 일시정지하고 사운드, 조작, 화면 설정을 변경하기 위한 기능 |
| Scope                  | Project A+                                                                |
| Level                  | User level                                                                |
| 작성자                 | 류재민                                                                    |
| Last Update            | 2026-05-07                                                                |
